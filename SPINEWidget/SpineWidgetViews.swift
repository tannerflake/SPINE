...
/// `SpineDeepLink` (see PushNotificationService.swift).
enum SpineWidgetLink {
    static let queue = URL(string: "spine://queue")!

    /// `spine://book/{bookId}?reader={uid}` — the reader is the friend whose
