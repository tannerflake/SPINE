...
final class SpineTagCatalog {
    static let shared = SpineTagCatalog()
    ...
    private static func loadParsed() -> (tags: [String], byCategory: [String: [String]]) {
        ...
        assertionFailure("Tags.csv missing from app bundle. Add Tags.csv to the SPINE target.")
