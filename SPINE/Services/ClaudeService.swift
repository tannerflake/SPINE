...
final class ClaudeService {
    ...
    /// SPINE never shows one, so ask up front (and strip anyway, below). The
    /// second rule kills the tell that shows up most in generated copy: a
    /// trailing "That's the ..." sentence tacked onto an otherwise fine line.
