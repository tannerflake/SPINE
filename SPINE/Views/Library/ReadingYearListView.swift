...
struct ReadingYearListView: View {
    ...
    var body: some View {
        ...
        .toolbar {
            ...
            // meant for the glass. The ToolbarSpacer below keeps the system from
            // re-merging them back into one capsule.
    ...
    private var moveActionBar: some View {
        HStack(spacing: 12) {
            ...
            Button {
                ...
                Label("Move to year", systemImage: "calendar.badge.clock")
            }
            .buttonStyle(.spine(.primary, size: .regular, fullWidth: false))
