...
//  SPINE
//
//  "How tiers work" explainer, shown after the library card and ahead of the
//  two hands-on tier steps (WizardTierPracticeStep). It answers the single
//  most common new-member question ("what does S mean?") with a live tier
