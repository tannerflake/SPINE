...
struct RootView: View {
    ...
    /// Launch with `-uiPreviewSplash` to hold the cold-start splash on screen
    /// indefinitely (it normally lasts only as long as auth takes to resolve).
    private var isSplashPreviewRun: Bool {
    ...
    /// Cold-start splash. Continues the static launch image frame-for-frame,
